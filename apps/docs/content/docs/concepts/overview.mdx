...
description: "These pages describe how Partha structures product data and UI. Partha models delivery as nested scopes inside a workspa"
---
...
- [Workspaces](/docs/concepts/workspaces) · [Teams](/docs/concepts/teams) · [Projects](/docs/concepts/projects) · [Milestones](/docs/concepts/milestones) · [Sprints](/docs/concepts/sprints) · [Issues](/docs/concepts/issues)
