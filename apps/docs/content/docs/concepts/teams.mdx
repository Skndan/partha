---
title: "Teams"
description: "In Partha, teams group people and work inside a workspace. Each team has a human-readable name and short key (normalized"
---
...
`list_teams`, `get_team`, `create_team`, `update_team` — scope `workspace:read` / `workspace:write` as described in [`/docs/mcp/scopes`](/docs/mcp/scopes).
